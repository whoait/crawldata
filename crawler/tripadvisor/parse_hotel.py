...
class TripadvisorHotel(BaseHotel):
    # BaseHotel receives soup for hotel listing
    def __init__(self, driver, base_url):
        super(TripadvisorHotel, self).__init__(driver, base_url)
    ...
    def parse_entity_source_rating(self):
        ...
        if rating_soup:
            ...
            aspect_soup = rating_soup.find(
                id="SUMMARYBOX").find("ul")
            if aspect_soup:
