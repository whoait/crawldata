...
class TripAdvisorRestaurantBaseSpider(BaseSpider):
	...
	def parse_search_page(self, response):
		...
		tripadvisor_address_item['phone'] = clean_parsed_string(get_parsed_string(snode_address, 'div[@class="contact_info"]/div[@class="odcHotel blDetails"]/div[@class="fl notLast"]/div[@class="fl phoneNumber"]/text()'))
		...
		tripadvisor_address_item['email'] = email
